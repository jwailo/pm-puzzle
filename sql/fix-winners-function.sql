-- First, let's check the structure of user_profiles table
...
BEGIN
    ...
    LEFT JOIN user_profiles up ON gs.user_id = up.id  -- Changed from up.user_id to up.id
...
-- Create corrected function to get completions for a specific date range
